function topo = CS5320_topo(points,normals,planes,k)
...
for i = 1+k:rows-k
    for j = 1+k:cols-k
        ...
        h90 = points(i-k:i+k,j,3)';
        h0 = points(i,j-k:j+k,3);
        temp_mat = points(i-k:i+k,j-k:j+k,3);
        h135 = diag(temp_mat)';
