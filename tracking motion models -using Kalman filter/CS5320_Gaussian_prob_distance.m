function d =  CS5320_Gaussian_prob_distance(obsVect, meanRGB, covarRGB)
...
%     d = distance;
% Call:
%     d =  CS5320_Gaussian_prob_distance([230 5 3], meanRGB, covarRGB)
% Author:
%     Clinton Fernandes
%     UU
%     Spring 2016
%
 ...
 d = 255*(1-exp(((obsVect-meanRGB)/covarRGB)^2));